...
public class TrickShotTest {
    ...
    private static Stream<Arguments> testResource() {
        return Stream.of(Arguments.of("x=20..30, y=-10..-5", 45, 112), Arguments.of("x=241..275, y=-75..-49", 2775, 1566));
    }

    @ParameterizedTest
    @MethodSource("testResource")
    public void testResourceTest(final String target, final int expectedHighest, final int expectedHits) {
