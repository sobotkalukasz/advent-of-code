...
class SunnyAsteroidsTest extends BaseTest {

    private static Stream<Arguments> simpleProgram() {
        return Stream.of(Arguments.of(new long[] { 3, 0, 4, 0, 99 }, 5, 5), //
                ...
                Arguments.of(
                        new long[] { 3, 21, 1008, 21, 8, 20, 1005, 20, 22, 107, 8, 21, 20, 1006, 20, 31, 1106, 0, 36,
                                98, 0, 0, 1002, 21, 125, 20, 4, 20, 1105, 1, 46, 104, 999, 1105, 1, 46, 1101, 1000, 1,
                                20, 4, 20, 1105, 1, 46, 98, 99 }, 7L, 999L), //
                Arguments.of(
                        new long[] { 3, 21, 1008, 21, 8, 20, 1005, 20, 22, 107, 8, 21, 20, 1006, 20, 31, 1106, 0, 36,
                                98, 0, 0, 1002, 21, 125, 20, 4, 20, 1105, 1, 46, 104, 999, 1105, 1, 46, 1101, 1000, 1,
                                20, 4, 20, 1105, 1, 46, 98, 99 }, 8L, 1000L), //
                Arguments.of(
                        new long[] { 3, 21, 1008, 21, 8, 20, 1005, 20, 22, 107, 8, 21, 20, 1006, 20, 31, 1106, 0, 36,
                                98, 0, 0, 1002, 21, 125, 20, 4, 20, 1105, 1, 46, 104, 999, 1105, 1, 46, 1101, 1000, 1,
                                20, 4, 20, 1105, 1, 46, 98, 99 }, 9L, 1001L));
    }

    @ParameterizedTest
    @MethodSource("simpleProgram")
    void simpleProgramTest(long[] program, long input, long expected) {
    ...
    private static Stream<Arguments> simpleProgramFile() {
        return Stream.of(Arguments.of("2019/SunnyAsteroids", 1L, 16348437L), //
                Arguments.of("2019/SunnyAsteroids", 5L, 6959377L));
    }

    @ParameterizedTest
    @MethodSource("simpleProgramFile")
    void simpleProgramFileTest(String fileName, long input, long expected) {
