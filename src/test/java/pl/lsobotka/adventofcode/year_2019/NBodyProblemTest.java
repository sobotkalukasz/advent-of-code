...
class NBodyProblemTest {
    ...
    void getTotalEnergy(final List<List<Integer>> input, final int steps, final long expected) {
    ...
    void simulateUniverse(final List<List<Integer>> input, final long expected) {
        final NBodyProblem nBodyProblem = new NBodyProblem(input);
