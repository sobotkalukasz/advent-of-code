package pl.lsobotka.adventofcode.year_2022.nospaceleft;
...
class NoSpaceLeftTest extends BaseTest {
    ...
    private static Stream<Arguments> firstStar() {
        return Stream.of(Arguments.of("2022/NoSpaceLeft_simple", 100_000, 95_437), //
                Arguments.of("2022/NoSpaceLeft", 100_000, 1_644_735));
    }
    ...
    private static Stream<Arguments> secondStar() {
        return Stream.of(Arguments.of("2022/NoSpaceLeft_simple", 70_000_000, 30_000_000, 24_933_642), //
                Arguments.of("2022/NoSpaceLeft", 70_000_000, 30_000_000, 1_300_850));
    }
