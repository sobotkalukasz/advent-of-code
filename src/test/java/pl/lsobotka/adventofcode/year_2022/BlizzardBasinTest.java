...
class BlizzardBasinTest extends BaseTest {
    ...
    private static Stream<Arguments> firstStar() {
        return Stream.of(Arguments.of("2022/BlizzardBasin_simple", 18), //
                Arguments.of("2022/BlizzardBasin", 314));
    }
    ...
    private static Stream<Arguments> secondStar() {
        return Stream.of(Arguments.of("2022/BlizzardBasin_simple", 54), //
                Arguments.of("2022/BlizzardBasin", 896));
    }
