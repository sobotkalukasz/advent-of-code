...
class CrabCupsTest {
    ...
    private static Stream<Arguments> cups() {
        return Stream.of(Arguments.of("389125467", 10, "92658374"), //
    ...
    @ParameterizedTest
    @MethodSource("cups")
    void cupsTest(String input, int moves, String expected) {
    ...
    private static Stream<Arguments> cupsAdvanced() {
        return Stream.of(Arguments.of("389125467", 1_000_000, 10_000_000, 149245887792L), //
                Arguments.of("398254716", 1_000_000, 10_000_000, 235551949822L));
    }

    @ParameterizedTest
    @MethodSource("cupsAdvanced")
    void cupsAdvancedTest(String input, int size, int moves, long expected) {
