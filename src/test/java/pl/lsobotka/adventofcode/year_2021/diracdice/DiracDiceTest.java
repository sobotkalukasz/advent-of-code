...
class DiracDiceTest {
    ...
    void testResourceTest(final int firstPos, final int secondPos, final long expected) {
    ...
    void quantumResourceTest(final int firstPos, final int secondPos, final long expected) {
