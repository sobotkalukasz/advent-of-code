...
public class BinaryBoardingTest extends BaseTest {

    private static Stream<Arguments> data() {
        return Stream.of(
                Arguments.of("BinaryBoarding", 835, 649)
        );
    }

    @ParameterizedTest
    @MethodSource("data")
    public void dayFiveFile(String fileName, int expectedBiggestID, int expectedSeatId) throws Exception {
