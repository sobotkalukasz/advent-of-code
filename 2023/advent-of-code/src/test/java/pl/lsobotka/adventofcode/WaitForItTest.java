...
class WaitForItTest extends BaseTest {
    ...
    private static Stream<Arguments> firstStar() {
        return Stream.of(Arguments.of("WaitForIt_example", 288), //
                Arguments.of("WaitForIt", 3317888));
    }
    ...
    private static Stream<Arguments> secondStar() {
        return Stream.of(Arguments.of("WaitForIt_example", 71503), //
                Arguments.of("WaitForIt", 24655068));
    }
