...
class GearRatiosTest extends BaseTest {
    ...
    private static Stream<Arguments> firstStar() {
        return Stream.of(Arguments.of("GearRatios_example", 4361), //
                Arguments.of("GearRatios", 517021));
    }
    ...
    private static Stream<Arguments> secondStar() {
        return Stream.of(Arguments.of("GearRatios_example", 467835), //
                Arguments.of("GearRatios", 81296995));
    }
