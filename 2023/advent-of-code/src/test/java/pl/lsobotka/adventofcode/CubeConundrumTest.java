...
class CubeConundrumTest extends BaseTest {
    ...
    private static Stream<Arguments> firstStar() {
        return Stream.of(Arguments.of("CubeConundrum_example", 8), //
                Arguments.of("CubeConundrum", 2061));
    }
    ...
    private static Stream<Arguments> secondStar() {
        return Stream.of(Arguments.of("CubeConundrum_example", 2286), //
                Arguments.of("CubeConundrum", 72596));
    }
