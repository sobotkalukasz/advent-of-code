...
class ParabolicReflectorDishTest extends BaseTest {
    ...
    private static Stream<Arguments> firstStar() {
        return Stream.of(Arguments.of("ParabolicReflectorDish_example", 136), //
                Arguments.of("ParabolicReflectorDish", 108_759));
    }
    ...
    private static Stream<Arguments> secondStar() {
        return Stream.of(Arguments.of("ParabolicReflectorDish_example", 1_000_000_000, 64), //
                Arguments.of("ParabolicReflectorDish", 1_000_000_000, 89_089));
    }
