...
class LensLibraryTest extends BaseTest {
    ...
    private static Stream<Arguments> firstStar() {
        return Stream.of(Arguments.of("LensLibrary_example", 1320), //
                Arguments.of("LensLibrary", 511_215));
    }
    ...
    private static Stream<Arguments> secondStar() {
        return Stream.of(Arguments.of("LensLibrary_example", 145), //
                Arguments.of("LensLibrary", 236_057));
    }
