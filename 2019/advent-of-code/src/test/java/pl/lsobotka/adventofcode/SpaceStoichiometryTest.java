...
public class SpaceStoichiometryTest extends BaseTest {
    ...
    public void simpleExampleOreCountTest(List<String> input, long expected) {
    ...
    private static Stream<Arguments> minimalOreCountTestResource() {
        return Stream.of(Arguments.of("SpaceStoichiometry", 114125));
    }
    ...
    public void simpleExampleFuelProduceTest(List<String> input, long expected) {
        final SpaceStoichiometry spaceStoichiometry = new SpaceStoichiometry(input);
    ...
    private static Stream<Arguments> maxFuelProduceTestResource() {
        return Stream.of(Arguments.of("SpaceStoichiometry", 12039407));
    }
