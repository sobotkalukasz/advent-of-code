...
public class MonitoringStationTest extends BaseTest {
    ...
    private static Stream<Arguments> asteroids() {
        return Stream.of(Arguments.of("MonitoringStation_example_01", 33),
                Arguments.of("MonitoringStation_example_02", 8), Arguments.of("MonitoringStation_example_03", 35),
                Arguments.of("MonitoringStation_example_04", 41), Arguments.of("MonitoringStation_example_05", 210),
    ...
    private static Stream<Arguments> destroyAsteroids() {
        return Stream.of(Arguments.of("MonitoringStation_example_05", 200, 802),
                Arguments.of("MonitoringStation", 200, 416));
    }
